...
public class TasksToRun {
    ...
    public void run() {
        Task_01(personsList);
        Task_02_vol_01(personsList);
        Task_02_vol_02(personsList);
        Task_03(personsList);
        Task_04(personsList);
    }

    private void Task_01(PersonsList personsList){
        System.out.println("\n Задача 1: Вывести на консоль отсортированные (по алфавиту) имена персонов.\n");
        homework.printNamesOrdered(personsList);
    }

    private void Task_02_vol_01(PersonsList personsList) {
    ...
    private void Task_02_vol_02(PersonsList personsList) {
    ...
    private void Task_03(PersonsList personsList) {
    ...
    private void Task_04(PersonsList personsList) {
